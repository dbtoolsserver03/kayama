...
～から～にかけて	从…到…（表示时间或场所）	NからNにかけて	日本では大学の入学試験は普通２月から３月にかけて行われる。	在日本，大学的入学考试一般在2月到3月间举行。
...
～ことだ	非常…,太…,表示感叹,一般后续感情或感觉用言	连体形（动词た形一般无）	ここで勉強したのはもう２０年も前のことだ、ああ懐かしいことだ。	在这儿学习已经是20多年前的事了，非常令人怀念。
～ことだから	因为是…所以…,表示从熟知的状况来判断	N+の/活用语连体形	時間に正確な彼女のことだから、もうすぐ来ますよ。	由于她向来守时，应该马上能到。
～ことなく	没有…,不…	动词する	山川さんは２０年間休むことなく、会社にかよった。	山川在20年里没有请假，在公司上班。
...
～てたまらない	…得不得了,非常…(不用于自然自发场合,由于外界因素造成的强烈的主观感觉)	V(て),形容词(くて),形动(で)	あと１点で合格できたと思うと悔しくてたまらない。	觉得差一分及格,所以后悔得不得了.
...
～に比べて/～に比べ	与…相比较	N/Vする+の	この辺りは１０年前に比べて、ずっとにぎやかになった。	这一带和十年前相比，变得热闹多了。
...
～ものだ②	是多么…啊(讲话人面对客观事实发出的真切感受)	用言连体形（V一般不用过去式）	今年は私も６０歳だ、年を取るのは早いものだ。	今年我已经60岁了，老得好快啊。
